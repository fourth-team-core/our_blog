...
from .views import (BaseUserPasswordChangeView, BaseUserPasswordResetView,
                    BaseUserProfileView, BlogUserLoginView, BlogUserSignUpView)
...
urlpatterns = [
    ...
    path(
        "password_change/",
        BaseUserPasswordChangeView.as_view(),
        name="password-change",
    ),
    path(
        "password_reset/",
        BaseUserPasswordResetView.as_view(),
        name="password-reset",
    ),
    path(
